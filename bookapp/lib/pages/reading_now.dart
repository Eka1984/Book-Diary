...
class _ReadingNowState extends State<ReadingNow> {
  ...
  _refreshData() async {
    final data = await DatabaseHelper.getItems(2);
    setState(() {
      myData = data;
    });
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        //validator: validateMyTextField, // You might want to create a specific validator for comments
                        controller: _commentsController,
                        // Define this controller in your state
